...
public class ObjectHandler {
    ...
    public Mono<ServerResponse> getObject(ServerRequest request){
        ...
        System.out.println("id of object is: "+id);
        logger.debug("id of object is: "+id);
        Mono<ServerResponse> notFound = ServerResponse.notFound().build();
        Mono<Object> objectMono = objectService.getObjectById(id);
        System.out.println("Found "+objectMono.toString());

        logger.debug("Found "+objectMono.toString());
        System.out.println(objectMono.block().getName());
